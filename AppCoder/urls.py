...
from AppCoder.views import  Curso_CreateView, Curso_DeleteView, Curso_DetailView, Curso_ListView, Curso_UpdateView, Estudiante_CreateView, Estudiante_DeleteView, Estudiante_DetailView, Estudiante_ListView, Estudiante_UpdateView, Profesor_CreateView, Profesor_DeleteView, Profesor_DetailView, Profesor_ListView, Profesor_UpdateView, buscarCurso, inicio, resultadoBuscarCurso
